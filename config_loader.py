...
class ConfigLoader:
    ...
    ENV_VAR_MAPPING = {
        ...
        'database.mariadb.database': 'MARIADB_DATABASE',
        'database.cache.backend': 'CACHE_BACKEND',
        'database.cache.host': 'KEYDB_HOST',
        'database.cache.port': 'KEYDB_PORT',
        'database.cache.ttl_seconds': 'CACHE_TTL_SECONDS',
