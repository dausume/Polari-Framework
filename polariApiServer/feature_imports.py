...
FEATURE_IMPORT_BLOCKS = (
    ...
    ('security', (
        ...
        ('security.security_basis', (
            ...
            'TrustChannel', 'AuthzRule', 'ContentPolicy', 'ContentPolicyViolation', 'SecurityEvent', 'PermissionObservation', 'BrowserPolicy', 'AppSecurityRecord', 'SecurityAuditRun', 'SshCapability', 'DeviceInventory', 'SshPermissionLevel', 'SECURITY_CLASSES',
        )),
