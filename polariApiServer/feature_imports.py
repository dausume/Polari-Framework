...
FEATURE_IMPORT_BLOCKS = (
    ...
    ('security', (
        ...
        ('security.security_basis', (
            ...
            'TrustChannel', 'AuthzRule', 'ContentPolicy', 'ContentPolicyViolation', 'SecurityEvent', 'PermissionObservation', 'ObservationSession', 'UsageObservation', 'RolePrototype', 'BrowserPolicy', 'AppSecurityRecord', 'SecurityAuditRun', 'SshCapability', 'DeviceInventory', 'SshPermissionLevel', 'SECURITY_CLASSES',
        )),
