...
check('GET /api/computelod/lod2/compare: the two Liberties\' twins at the SAME conditions — six pairs, three views, per-cell worst delays without the per-arc detail, CNT area refused',
      ...
      and r.json['report']['views']['own-fo4']['cells']['inv_1']['cnt']['worst_ps'] < 2 and 'arcs_detail' not in r.json['report']['views']['own-fo4']['cells']['inv_1']['sky130'] and r.json['report']['area']['cnt_um2'] is None, r.text[:300])
