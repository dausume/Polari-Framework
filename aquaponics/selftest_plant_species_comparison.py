...
Run from polari-framework/:
    python3 -m aquaponics.selftest_plant_species_comparison
...
from aquaponics.plant_skeleton import generate_skeleton
...
if __name__ == '__main__':
    ...
    from aquaponics.plant_skeleton import _pot_planting_geometry_mm
