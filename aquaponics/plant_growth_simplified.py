"""
@cross-cutting
@module aquaponics.plant_growth_simplified
@tags @xc:bindings
...
`aquaponics.plant_growth_normalized` — per-part normalized growth,
...
@consumers
  ...
  - mathshapes.growth_prediction (tower_growth_forecast — per-tier
    forecasts across many identical individuals)
  - nutrition.harvest_analysis (realized-vs-mature harvest yield)
...
#: aquaponics.plant_growth_normalized.transport_factor() (phase 9) for
...
def grow(manager, plant_name, days=60.0, dt_days=1.0, supply_factor=1.0,
    ...
    return {
        ...
        'note': 'SIMPLIFIED/AGGREGATE model — constants + the growth '
                ...
                'aquaponics.plant_growth_normalized (the real, single-'
...
def estimate_interactions(state):
    ...
    return {
        ...
        'note': 'ABSTRACT prior, not measured — magnitude = sign · '
                ...
                'see aquaponics.plant_growth_normalized.'
