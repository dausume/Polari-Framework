"""
@cross-cutting
@module aquaponics.nutrient_uptake
@tags @xc:bindings
...
job (aquaponics.plant_stress's own 'co2'/'oxygen' stress types already
cover them from AtmosphereDefinition/WaterDefinition fields), not this
water-nutrient-concentration computation.

@consumers
  - aquaponics.plant_growth_normalized.advance_growth (feeds
...
#: (aquaponics.plant_stress's 'co2'/'oxygen' stress types), not a
