...
per-part state (aquaponics.plant_growth_normalized) + the animation-
bones vector graph generator (aquaponics.plant_skeleton).

Run from polari-framework/:
    python3 -m aquaponics.selftest_plant_growth_normalized
