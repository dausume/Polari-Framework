...
class managedDB_testClass(unittest.TestCase):
    ...
    def test_singleDefault(self):
        classJSON = getJSONforClass(definingFile='managedDB', className='managedDatabase', passedInstances=self.defaultTestClass )
        print(classJSON)
    ...
    def test_singleNamed(self):
        classJSON = getJSONforClass(definingFile='managedDB', className='managedDatabase', passedInstances=self.namedTestClass )
        print(classJSON)