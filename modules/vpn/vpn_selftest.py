...
Run from polari-framework/:
    python3 -m vpn.vpn_selftest                    (container root)
    PYTHONPATH=.:modules python3 -m vpn.vpn_selftest   (host)
...
from vpn.custom.vpn_proposals import propose, validate_proposal
...
from vpn.custom.vpn_trust import file_join_request, on_agreement_event, proposals_of_agreement
m3 = manager()
api3 = api_for(m3)
...
sink = _R()
from vpn.custom.vpn_demo import base_push, ISLE_A
