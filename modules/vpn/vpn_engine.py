...
@consumers
  - vpn.vpn_api (render endpoint, ingest sanity), vpn.vpn_proposals
  - vpn.vpn_demo (the two-isle acceptance flow)
  - vpn.selftest_vpn
"""
...
from islemesh.islemesh_netledger import cidrs_overlap, free_port
