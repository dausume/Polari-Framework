...
Run from polari-framework/:
    python3 -m scoring.selftest_assertions
...
from scoring.contributors import SEED_CONTRIBUTORS, contributor_record
from scoring.data_ingestion import ingest_records
from scoring.evidence import SEED_EVIDENCE_POLICIES, evidence_weight
