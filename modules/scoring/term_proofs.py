...
@consumers
  - scoring.term_competition (proofs back scope votes / relations /
...
SEED_MANIPULATION_PATTERNS = [
    _pattern('aggregation-masking', 'Aggregation masking',
             ...
             check='scoring.term_proofs:check_aggregation_masking',
    ...
    _pattern('outlier-driven-mean', 'Outlier-driven mean',
             ...
             'divergence.',
             check='scoring.term_proofs:check_outlier_driven_mean',
             computability='computable'),
    _pattern('stale-vintage', 'Stale vintage presented as current',
             ...
             'declared timeframe.',
             check='scoring.term_proofs:check_stale_vintage',
             computability='computable'),
