"""@module scoring.objects.data_gathering._shared — what the data_gathering row classes share (constants, seeds, helpers); split from data_gathering_basis.py (sap-2c)."""
...
GATHERING_COMPILER_REF = ('scoring.data_gathering_basis'
