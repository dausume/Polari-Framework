"""
@module scoring.objects.score_concept.ScoreConcept

Row class ScoreConcept of the scoring module — one class per file (design §7), split
from score_concept_basis.py (sap-2c). The class docstring below is the explanation.
"""
