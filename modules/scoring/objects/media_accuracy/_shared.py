"""@module scoring.objects.media_accuracy._shared — what the media_accuracy row classes share (constants, seeds, helpers); split from media_accuracy_basis.py (sap-2c)."""
