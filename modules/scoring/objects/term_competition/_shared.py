"""@module scoring.objects.term_competition._shared — what the term_competition row classes share (constants, seeds, helpers); split from term_competition_basis.py (sap-2c)."""
