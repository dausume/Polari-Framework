...
Run from polari-framework/:
    python3 -m scoring.credibility_bases_selftest
...
from scoring import credibility_bases_basis as cb
from scoring.assertion_credibility_basis import cast_credibility_vote
from scoring.term_competition_basis import assert_term_relation
from scoring.term_proofs_basis import (cast_proof_vote, proof_reading,
                                 raise_rebuttal)
