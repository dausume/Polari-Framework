...
Run from polari-framework/:
    python3 -m scoring.policy_intent_selftest
...
from scoring.policy_drafts_basis import create_draft
from scoring.policy_intent_basis import (WHO_MAY_SET, current_intent,
