...
Run from polari-framework/:
    python3 -m scoring.selftest_bias
...
from scoring.group_bias import SEED_BIAS_POLICIES, group_bias_report
from scoring.media_accuracy import (
    SEED_ACCURACY_POLICIES, SEED_FACTUAL_CLAIMS, SEED_MEDIA_OUTLETS,
)
from scoring.policy_votes import SEED_COHORT_GROUPS
...
from scoring.worldview_elections import SEED_ASSEMBLY_GROUPS
