...
geopolymer BONDS (the supplychain.mold_analysis rule) — a
...
from casting.chain_analysis import _thermal_profile
from casting.fill_sim import _sprue_instance_for
