...
Run from polari-framework/:
    python3 -m casting.casting_selftest
...
from casting.fill_sim_basis import compute_fill_rows, simulate_fill
from casting.interventions_basis import evaluate_intervention
...
from casting.custom.pour_loading import exotherm_check, pour_loading_report
from pspp.ceramics_ladder_basis import SEED_LADDER_RUNGS
from pspp.ceramics_samples_basis import SEED_CERAMIC_SAMPLES
from casting.custom.mold_geometry import derive_mold, scale_quadric_flat
from casting.custom.voxel_grid import OccupancyGrid
from casting.custom.wax_feasibility import (
    master_report, print_time_estimate, printable_criteria,
    wax_master_report, wax_self_support,
)
from mathshapes.custom.shape_analysis import evaluate_point, shape_properties
...
if __name__ == '__main__':
    ...
    from casting.custom.simulation_gaps import (
