...
- **objects** — `objects/casting/CastingMaterialThermalProfile.py`, `objects/casting/MasterFeedstockDefinition.py`, `objects/casting/MoldDefinition.py`, `objects/casting/_shared.py`, `objects/chain/CastingStageDefinition.py`, `objects/chain/MoldNestingChain.py`, `objects/chain/_shared.py`, `objects/coatings/CastingRunRecord.py`, `objects/coatings/MoldCoatingDefinition.py`, `objects/coatings/_shared.py`, `objects/demold/DemoldPlanDefinition.py`, `objects/demold/_shared.py`, … (9 more)
