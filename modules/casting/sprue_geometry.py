...
instruments instead of inventing new ones:
  ...
  - geometry lands as bounded cone-quadric `-eq` rows via
    mathshapes.shape_modify.build_quadric_eq_row — the pot-hole
...
from casting.mold_geometry import _converge_shape_rows, _mold_named
...
from mathshapes.shape_modify import build_quadric_eq_row
