"""
@cross-cutting
@module casting.custom.pour_loading
@tags @xc:bindings
...
from mathshapes.custom.shape_analysis import _named, _shape_bounds
...
def _part_extents(manager, mold):
    ...
    if part is None or getattr(part, 'family', '') == 'imported-mesh':
        ...
        if part is None:
            from casting.custom.mold_geometry import _resolve_imported_shape
...
def pour_loading_report(manager, mold_name, feedstock_name=None,
    ...
    from casting.custom.wax_feasibility import _body_volume
