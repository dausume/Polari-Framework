"""
@cross-cutting
@module casting.custom.chain_analysis
@tags @xc:bindings
...
supplychain.custom.mold_analysis rule: no proven capillarity) and cast-3's
...
from casting.custom.pour_loading import EXOTHERM_MEASURED, EXOTHERM_SOURCE
    ...
    for st in stages:
        ...
        if (fill == 'slip-cast'
            ...
            blockers.append(
                ...
                f'(supplychain.custom.mold_analysis rule); press plastic '
                f'clay instead')
