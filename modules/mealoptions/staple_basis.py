...
#: The instance-pointer fields a shipped seed must leave blank
#: (the selftest pins this).
...
#: Demo staples: the four cadences populated. Bulk prices are DEMO
#: observations (is_prior) — a household replaces them with what it
#: actually sees, on its own row, with its own location and date.
SEED_BULK_STAPLES = [
