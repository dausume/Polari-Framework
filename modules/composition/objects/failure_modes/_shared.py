"""@module composition.objects.failure_modes._shared — what the failure_modes row classes share (constants, seeds, helpers); split from failure_modes_basis.py (sap-2c)."""
