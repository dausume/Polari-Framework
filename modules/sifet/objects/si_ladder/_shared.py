"""@module sifet.objects.si_ladder._shared — what the si_ladder row classes share (constants, seeds, helpers); split from si_ladder_basis.py (sap-2c)."""
...
def apply_anchor_knob(manager, device_name):
    ...
    device.vfb_source = (
        ...
        f'{_FPDK45_SRC}')
    from sifet.custom.si_device import derive_si_device as _derive
