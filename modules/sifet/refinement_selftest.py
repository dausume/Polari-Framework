"""
Selftest for sifet.si_refinement_basis (fp-4: silicon grade ladder,
...
Run from polari-framework/modules/:
  PYTHONPATH=..:../polariApiServer python3 -m sifet.refinement_selftest
"""
...
from sifet import si_refinement_basis as sr
