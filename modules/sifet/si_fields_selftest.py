"""
Selftest for sifet.custom.si_fields (fg-4, last item: the silicon field
...
Run from polari-framework/modules/:
  PYTHONPATH=..:../polariApiServer python3 -m sifet.si_fields_selftest
"""
...
def main():
    ...
    from cntfet.cnt_device_viz_seed import device_curve_points
