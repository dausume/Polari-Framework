...
@consumers
  - cntfet.cnt_transport.transport_report (Si dispatch)
  - cnt_api GET /api/fet/device/{name}/transport (via the dispatch)
  - sifet.selftest_si_transport
"""
...
from sifet.si_device import get_row, resolve_components
...
def si_transport_report(manager, device, p, vgs=None, vds=None,
    ...
    from sifet.si_model import ballisticity
