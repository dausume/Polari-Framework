...
sifet.si_fields and bands with SI_FIELD_BANDS) ride the cubes along
...
@consumers
  ...
  - sifet.selftest_si_scene
"""

import json

from cntfet.cnt_fields import FIELD_KNOBS, SCALAR_FIELDS, run_ref
from cntfet.cnt_parts_svg import PARTS2D_KNOBS, _si_layout
from cntfet.cnt_scene import scene_name
from sifet.si_device import get_row
