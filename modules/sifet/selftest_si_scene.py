...
sampling (sifet.si_scene, cnt_fields.sample_fields with
SI_FIELD_BANDS) and the fet-2d scale normalization that fixed the
gray-viewport bug.

Run from polari-framework/modules/:
  PYTHONPATH=..:../polariApiServer python3 -m sifet.selftest_si_scene
"""
...
from cntfet.cnt_parts_svg import fet2d_scene
...
from sifet.si_scene import SEED_SI_DEVICE_SCENES, si_device_scene
