...
@consumers
  - cntfet.cnt_device_viz_seed.device_model (dispatch — to be wired)
...
def capability():
    ...
    return {
        ...
        'fidelity': 'VS_SI_MINIMAL — [KHA09] virtual-source core '
                    '(REUSED from cntfet.custom.cnt_vs_model) parameterized '
