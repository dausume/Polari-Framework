"""
Selftest for sifet.custom.si_transport (fg-4: the silicon scattering
...
Run from polari-framework/modules/:
  PYTHONPATH=..:../polariApiServer python3 -m sifet.si_transport_selftest
"""
...
from sifet.custom import si_transport as sit
from sifet.custom.si_device import derive_si_device, get_row
from sifet.custom.si_model import effective_mobility
