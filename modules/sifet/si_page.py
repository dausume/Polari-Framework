...
@consumers
  ...
  - sifet.sifet_pages_selftest
"""

import json

from cntfet.custom.cnt_compare import detail_pages, score_pages
...
def refinement_points(manager, route=REFINEMENT_ROUTE,
    ...
    from sifet.si_refinement_basis import impurity_ladder_rows, scheil_rows
