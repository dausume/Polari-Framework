...
@consumers
  - cntfet.cnt_fields.field_profile (Si dispatch)
  - cnt_api GET /api/fet/device/{name}/fields (via the dispatch)
  - cntfet.cnt_parts_svg (the 2-D overlay)
  - sifet.selftest_si_fields
"""

import math

from cntfet.cnt_states import frame_at
from sifet.si_device import get_row, resolve_components, si_device_model
from sifet.si_model import KB_J_PER_K, Q_C, lit, thermal_voltage_v
...
from cntfet.cnt_parts_svg import PARTS2D_KNOBS  # noqa: E402
...
def _potential_si(p, geo, frame, xs):
    ...
    from cntfet.cnt_fields import _analytic_ec
