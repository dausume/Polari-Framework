...
the cntfet fv/fi machinery unchanged.
    ...
    cd modules && PYTHONPATH=..:../polariApiServer \\
        python3 -m sifet.selftest_sifet
"""
...
from cntfet.cnt_states import state_at_bias, transitions_on_sweep
...
def main():
    ...
    check('cntfet.cnt_metrics.extract_metrics runs: SS + DIBL '
    ...
    check('cntfet.cnt_states.state_at_bias: off at Vg 0, on at Vg 1.0',
    ...
    check('cntfet.cnt_scoring.fet_validity: the NMOS is a valid FET',
