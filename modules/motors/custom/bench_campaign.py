"""
@module motors.custom.bench_campaign
...
motors.clock_views_basis (motion-view section), motors.motors_selftest
"""
...
def bench_campaign(manager, design_name=PRODUCT):
    ...
    try:
        from motors.custom.inductance import model_validity, solve_inductance
    ...
    try:
        from motors.custom.local_route import minimum_drive_current
...
def m1_bench_campaign(manager, design_name=M1):
    ...
    try:
        from motors.m1_views_seed import m1_phase_electrics
    ...
    entries.append(_entry(
        ...
        'finding', pred_r))
    try:
        from motors.custom.inductance import solve_inductance
    ...
    try:
        from motors.custom.m1_sequencing import STEP_DEG, sequence_sim
...
def m2_bench_campaign(manager, design_name=M2):
    ...
    try:
        from motors.custom.m2_rotation import pull_out_load_limit as _po
    ...
    try:
        from motors.m1_views_seed import m1_phase_electrics as _pe
        pe2 = _pe(manager, design_name)
        if pe2.get('ok'):
            r_phase = pe2['phases'][0]['rPhaseOhm']
            import json as _json2
            from motors.custom.motor_designer import _design, _loads
