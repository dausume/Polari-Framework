"""
@module motors.custom.inductance
...
@consumers motors.motor_api, motors.custom.local_route, motors.motors_selftest
"""
...
def solve_inductance(manager, design_name='clock-lavet-m0',
    ...
    from motors.custom.motor_designer import _prop
