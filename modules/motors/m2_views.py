...
motors.selftest_m2, polariServer seed pass (seed_m2_views)
"""
...
import motors.m1_views  # noqa: F401,E402
...
M2_SECTION_SOURCES = {
    'm2-rotation': _src_m2('motors.m2_rotation', 'rotation_sim'),
    'm2-pull-out': _src_m2('motors.m2_rotation',
                           'pull_out_load_limit'),
    'm2-back-emf': _src_m2('motors.m2_rotation',
                           'back_emf_constant'),
    'm2-lift-proof': _src_m2('motors.m2_lift', 'lift_proof'),
    'm2-hoist-requirements': _src_m2('motors.m2_lift',
                                     'hoist_report'),
    'm2-relations': _src_m2('motors.m2_composition',
                            'm2_relation_report'),
    'm2-promotion-story': lambda m, a: __import__(
        'motors.m2_composition', fromlist=['m2_promotion_story']
    ...
    'm2-phase-electrics': _src_m2('motors.m1_views',
                                  'm1_phase_electrics'),
}
...
from motors.m2_scene import m2_scene_json_for_view  # noqa: E402
