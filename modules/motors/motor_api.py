...
from magnetics.custom.magnet_analysis import _rows
...
class MotorsAPI(treeObject):
    ...
    def on_get_m1_positioning_proof(self, request, response,
                                    design_name):
        from motors.m1_positioning_basis import positioning_proof
        def num(k, d):
            try:
                return float(request.params.get(k, d))
            except (TypeError, ValueError):
    ...
    def on_get_m1_relations(self, request, response):
        from motors.m1_relations_seed import relation_report
    ...
    def on_get_m1_overlap_gap(self, request, response):
        from motors.m1_relations_seed import overlap_model_gap
    ...
    def on_get_m1_arc_rule(self, request, response):
        ...
        from motors.m1_relations_seed import arc_rule_report
    ...
    def on_get_m2_rotation(self, request, response, design_name):
        from motors.custom.m2_rotation import rotation_sim
    ...
    def on_get_m2_pull_out(self, request, response, design_name):
        from motors.custom.m2_rotation import pull_out_load_limit
    ...
    def on_get_m2_back_emf(self, request, response, design_name):
        from motors.custom.m2_rotation import back_emf_constant
    ...
    def on_get_m2_hoist(self, request, response, design_name):
        from motors.m2_lift_basis import hoist_report
    ...
    def on_get_m2_lift_proof(self, request, response, design_name):
        from motors.m2_lift_basis import lift_proof
    ...
    def on_get_m2_relations(self, request, response):
        from motors.m2_composition_seed import m2_relation_report
    ...
    def on_get_materials_audit(self, request, response):
        from motors.custom.materials_audit import materials_audit
        out = materials_audit(
            self.manager,
    ...
    def on_get_materials(self, request, response, design_name):
        from motors.custom.motor_materials import material_accountability
    ...
    def on_get_drive(self, request, response, design_name):
        from motors.motor_drive_basis import simplefoc_config
    ...
    def on_get_loads(self, request, response, design_name):
        from motors.custom.motor_stress import load_cases
        try:
    ...
    def on_get_criterion(self, request, response, material):
        from motors.custom.motor_stress import failure_criterion
    ...
    def on_get_true_price(self, request, response, design_name,
                          part_name):
        from motors.custom.lifecycle_cost import cheapest_configuration
        try:
    ...
    def on_get_contact(self, request, response, design_name,
                       part_name):
        from motors.custom.contact_wear import contact_stress
        out = contact_stress(
            self.manager, design_name, part_name,
    ...
    def on_get_product(self, request, response, design_name):
        from motors.custom.clock_product import product_datasheet
    ...
    def on_get_equations(self, request, response):
        from motors.physics_equations_seed import (
    ...
    def on_get_roles(self, request, response, part_name):
        from motors.custom.part_roles import part_role_report
    ...
    def on_get_role_screen(self, request, response, part_name):
        from motors.custom.part_roles import screen_candidates
    ...
    def on_get_fatigue(self, request, response, design_name,
                       part_name):
        from motors.custom.motor_fatigue import part_fatigue
    ...
    def on_get_substitutes(self, request, response, design_name,
                           part_name):
        from motors.custom.motor_fatigue import substitution_search
    ...
    def on_get_winding_sweep(self, request, response, design_name):
        from motors.custom.motor_winding import gauge_sweep
    ...
    def on_get_verify(self, request, response, design_name):
        from motors.custom.motor_verify import verification_summary
    ...
    def on_post_verify(self, request, response, design_name):
        ...
        from motors.custom.motor_verify import record_verification_run
        try:
    ...
    def on_get_local_route(self, request, response):
        from motors.custom.local_route import solve_local_route
    ...
    def on_get_producible_clock(self, request, response):
        from motors.custom.local_route import producible_clock
    ...
    def on_get_turns_sweep(self, request, response):
        from motors.custom.local_route import turns_sweep
        out = turns_sweep(
            self.manager,
            request.params.get('design', 'clock-lavet-m0'),
            rotor_material=request.params.get('rotor', ''),
    ...
    def on_get_inductance(self, request, response):
        from motors.custom.inductance import pulse_response
        out = pulse_response(
            self.manager,
            request.params.get('design', 'clock-lavet-m0'),
            stator_material=request.params.get('stator', ''))
    ...
    def on_get_inductance_turns(self, request, response):
        from motors.custom.inductance import inductance_across_turns
    ...
    def on_get_model_validity(self, request, response):
        from motors.custom.inductance import model_validity
        out = model_validity(
            self.manager,
            request.params.get('design', 'clock-lavet-m0'))
        if not out.get('ok'):
    ...
    def on_get_wire_insulation(self, request, response):
        from motors.custom.wire_insulation import (
    ...
    def on_get_local_wire_route(self, request, response):
        from motors.custom.wire_insulation import local_wire_route
    ...
    def on_get_simplest(self, request, response):
        from motors.custom.simple_first import manufacturable_ladder
        def f(k, d):
            try:
                return float(request.params.get(k, d))
            except (TypeError, ValueError):
    ...
    def on_get_road_to_advanced(self, request, response):
        from motors.custom.simple_first import road_to_advanced
        response.media = road_to_advanced(self.manager)

    def on_get_clock_views(self, request, response):
        from composition.custom.data_refs import rows as _crows
        out = []
    ...
    def on_get_clock_view(self, request, response, view_name):
        from motors.clock_views_basis import view_payload
    ...
    def on_get_clock_scene(self, request, response, view_name):
        ...
        from motors.clock_scene_basis import clock_scene_payload
    ...
    def on_get_clock_assembly(self, request, response):
        ...
        from motors.clock_assembly_seed import clock_assembly_report
    ...
    def on_get_timekeeping_proof(self, request, response):
        ...
        from motors.clock_assembly_seed import timekeeping_proof
    ...
    def on_get_product_routes(self, request, response):
        ...
        from motors.product_routes_seed import product_routes
    ...
    def on_get_bench_campaign(self, request, response):
        ...
        from motors.custom.bench_campaign import bench_campaign
    ...
    def on_get_distributed_traction(self, request, response):
        ...
        &max_axles=)."""
        from motors.custom.distributed_traction import (
    ...
    def on_get_component_view(self, request, response, part_name):
        from motors.clock_views_basis import component_view
    ...
    def on_get_goal(self, request, response, goal_name):
        from motors.scale_goals_basis import goal_feasibility
        response.media = goal_feasibility(self.manager, goal_name)

    def on_get_scale_study(self, request, response):
        from motors.scale_goals_basis import scale_study
        policy = request.params.get('policy',
