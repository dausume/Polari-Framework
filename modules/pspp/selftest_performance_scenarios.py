...
Run from polari-framework/ (modules/ on the path):
    python3 -m pspp.selftest_performance_scenarios
"""
...
from pspp.exposure_scenarios import SEED_EXPOSURE_SCENARIOS
from pspp.performance_scenarios import run_performance_scenario
