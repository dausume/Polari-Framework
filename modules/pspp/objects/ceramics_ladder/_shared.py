"""@module pspp.objects.ceramics_ladder._shared — what the ceramics_ladder row classes share (constants, seeds, helpers); split from ceramics_ladder_basis.py (sap-2c)."""
import json
