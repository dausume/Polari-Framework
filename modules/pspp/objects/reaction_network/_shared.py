"""@module pspp.objects.reaction_network._shared — what the reaction_network row classes share (constants, seeds, helpers); split from reaction_network_basis.py (sap-2c)."""
import json
