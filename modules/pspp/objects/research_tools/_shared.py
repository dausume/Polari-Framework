"""@module pspp.objects.research_tools._shared — what the research_tools row classes share (constants, seeds, helpers); split from research_tools_basis.py (sap-2c)."""
