"""@module pspp.objects.threshold_windows._shared — what the threshold_windows row classes share (constants, seeds, helpers); split from threshold_windows_basis.py (sap-2c)."""
...
def merged_family_windows(symmetric_windows, banded_windows, family):
    ...
    from pspp.reaction_windows_basis import window_dict
...
def grade_composition_merged(symmetric_windows, banded_windows,
    ...
    from pspp.reaction_windows_basis import grade_value
