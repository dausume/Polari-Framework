"""@module pspp.objects.ceramics_samples._shared — what the ceramics_samples row classes share (constants, seeds, helpers); split from ceramics_samples_basis.py (sap-2c)."""
