"""@module pspp.objects.solgel_sourcing._shared — what the solgel_sourcing row classes share (constants, seeds, helpers); split from solgel_sourcing_basis.py (sap-2c)."""
import json
...
def _run_waterglass(route, n_tetrahedra, seed):
    ...
    from pspp.custom.solgel_network import waterglass_inventory
