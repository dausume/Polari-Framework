...
Run from polari-framework/ (modules/ on the path):
    python3 -m pspp.material_states_selftest
"""

import sys
from types import SimpleNamespace

from pspp.material_states_basis import (
    CANONICAL_STATE, SEED_PROCESSING_STAGES,
)
from pspp.custom.state_resolution import (
    branch_lineage, material_states, resolve_state,
    scale_definitions_for_state, state_key,
)
from pspp.claims_basis import claims_for_subject
