...
@consumers
  ...
  - pspp.dataset_interpolation (returns claim-shaped evidence payloads)
"""
...
from pspp.evidence_methods import validate_evidence_method
...
class PropertyClaim(treeObject):
    ...
    def __init__(
        ...
        value_json: str = '',
        units: str = '',
        # EvidenceMethod identifier (pspp.evidence_methods vocabulary).
