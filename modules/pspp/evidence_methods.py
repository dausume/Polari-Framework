...
to be known, as editable rows. Claims (pspp.claims) and scale rows
...
@consumers
  ...
  - pspp.claims (validate_claim checks evidence_method against this)
"""
