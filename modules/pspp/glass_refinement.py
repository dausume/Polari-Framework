...
@consumers
  ...
  - pspp.viscous_sintering (η(T) for the viscous work integral)
  - pspp.pspp_api (GET /api/pspp/glass/refinement)
  - pspp.selftest_glass_refinement
"""
...
def refinement_report(points=None, windows=None):
    ...
    the devit data ask."""
    from pspp.threshold_windows import banded_window_dict
    fit = fit_vft(points)
    return {
        'ok': True,
