"""
@module pspp.custom.solgel_network
...
and the numeric curves live in pspp.custom.solgel_process as points-empty
...
@consumers
  ...
  - pspp.custom.network_stepping (rules passed explicitly or via live rows)
  - pspp.custom.solgel_structure (inventory + route demos)
"""
...
#: pspp.threshold_windows_basis): grade 'failure' = pathway CLOSED.
_COARSE_PH_NOTE = ('COARSE boundary at neutral pH — the real '
                   ...
                   '(pspp.custom.solgel_process datasets).')
