...
pspp.solgel_process). Every payload says so.

@consumers
  - pspp.pspp_api (/api/pspp/solgel/routes)
  - pspp.selftest_solgel_structure
"""
...
from pspp.structure_groups import _ranked_groups, inventory_q_fractions
