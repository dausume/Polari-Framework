"""@module reticulum.objects.device_catalog._shared — what the device_catalog row classes share (constants, seeds, helpers); split from device_catalog_basis.py (sap-2c)."""
import json
