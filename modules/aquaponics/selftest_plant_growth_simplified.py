...
aquaponics/plant_growth_simplified.py's own module docstring for the
full "one real model + a distilled aggregate wrapper" design).

Run from polari-framework/:
    python3 -m aquaponics.selftest_plant_growth_simplified
...
from aquaponics.plant_growth_normalized import closed_form_logistic
from aquaponics.plant_growth_seed import SEED_PLANT_GROWTH_MODELS
from aquaponics.plant_growth_simplified import (
