"""
@cross-cutting
@module aquaponics.custom.plant_skeleton
...
SAME pot-local coordinate frame aquaponics.custom.hydraulics.water_slice_mesh
already uses — z vertical through the pot's own center, reused via
mathshapes.custom.shape_modify._pot_core_dimensions so a skeleton drops into
...
@consumers
  - the plant-viz SimSpace scene (mathshapes.custom.pot_scene.
...
def generate_skeleton(manager, planting_name,
    ...
    point."""
    from aquaponics.plant_growth_normalized_basis import _named as _pn_named
