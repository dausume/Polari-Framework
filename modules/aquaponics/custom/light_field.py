"""
@cross-cutting
@module aquaponics.custom.light_field
@tags @xc:bindings
...
absorbed-PPFD value, ready to feed aquaponics.plant_stress_basis's 'light'
...
@consumers
  - aquaponics.plant_growth_normalized_basis.advance_growth (via a local
