"""
@cross-cutting
@module aquaponics.custom.atmosphere_analysis
@tags @xc:bindings
...
@consumers
  - aquaponics.atmosphere_api / aquaponics.atmosphere_selftest / aqp-6
@see /AQUAPONICS_MODULE_PLAN.md
"""

import math

from aquaponics.custom.plant_analysis import plant_gas_nutrient_budget
