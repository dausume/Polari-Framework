...
# ---------------------------------------------------------------
# Seeds. Vocabulary rows are connector STANDARDS (factual);
# example parts are honestly UNPRICED — a dated price lands when
# one is actually sourced (the ai-8 rule).
# ---------------------------------------------------------------
...
#: Taxonomy rows for the two NEW part kinds (join
#: SEED_COMPUTER_PART_CLASSES in the same upsert pass).
