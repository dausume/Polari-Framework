"""
@module household.household_analysis
...
nutrition.logistics_analysis imports. `WTYPE_OF_CATEGORY` (event
...
nutrition.logistics_analysis, which re-exports everything here.

@consumers
  - nutrition.logistics_analysis (re-export + the meal builders)
  - AnalysisDefinition rows `household.household_analysis:<fn>`
    (the calendar dispatcher resolves callable refs by string)
  - household.selftest_household
"""
...
#: (nutrition.logistics_analysis: pre-prep / meal-prep / packing).
STEP_BUILDERS = {}
