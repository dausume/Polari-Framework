"""@module foodstate.objects.food_contracts._shared — what the food_contracts row classes share (constants, seeds, helpers); split from food_contracts_basis.py (sap-2c)."""
import json
