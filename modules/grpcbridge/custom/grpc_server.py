"""
@module grpcbridge.custom.grpc_server
...
@consumers
  ...
  - grpcbridge.custom.transport_mux (Watch/Commands fan-out)
...
class PolariGrpcServer:
    ...
    def refresh(self):
        ...
        with)."""
        try:
            from grpcbridge.custom.descriptor_build import runtime_from_manager
