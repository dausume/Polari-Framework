"""
@module electrodevice.circuit_netlist_seed
...
from electrodevice.custom.spice_run import LED_MODEL, capability, ngspice_bin
...
def render_circuit(manager, circuit_name):
    ...
    control += ['quit', '.endc']
    netlist = '\n'.join(
        [f'* Generated by Polari electrodevice.circuit_netlist_seed from '
...
SEED_CIRCUIT_COMPILER = {
    ...
    'domain': 'circuit',
    'compiler_ref': 'electrodevice.circuit_netlist_seed:compile_circuit',
