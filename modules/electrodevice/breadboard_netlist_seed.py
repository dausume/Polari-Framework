"""
@module electrodevice.breadboard_netlist_seed
...
from electrodevice.circuit_netlist_seed import (_device_card,
...
def render_breadboards(manager, board_names, analyses=None,
    ...
    from electrodevice.custom.spice_run import LED_MODEL
    control = _control_block(analyses, probes, lines)
    netlist = '\n'.join(
        [f'* Generated by Polari electrodevice.breadboard_netlist_seed '
