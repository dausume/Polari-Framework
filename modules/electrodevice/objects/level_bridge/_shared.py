"""@module electrodevice.objects.level_bridge._shared — what the level_bridge row classes share (constants, seeds, helpers); split from level_bridge_basis.py (sap-2c)."""
