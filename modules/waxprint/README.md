...
- **objects** — `objects/sim_state/WaxPrintSimState.py`, `objects/waxprint/DeviceMaterialDefinition.py`, `objects/waxprint/MoldLifecycleRecord.py`, `objects/waxprint/PrintConditionDefinition.py`, `objects/waxprint/PrinterAssemblyDefinition.py`, `objects/waxprint/WaxFeedstockDefinition.py`, `objects/waxprint/WaxReclaimBatch.py`, `objects/waxprint/_shared.py`
