...
SEED_COMPUTELOD_PAGE_DISPLAYS = [
    _page('computelod', 'computelod',
          ...
          'ComputeLOD', [
              ...
              _row(3, [_table('computelod-artifacts', 0, 12, 'Compiler artifacts (source, assembly, object) — of ONE compiler; IR is not a rung', 'CompilerArtifact', columns='name,kind,compiler,source_ref,content_ref,notes')]),
