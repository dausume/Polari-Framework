"""
Selftest for resources.custom.profile_measure (res-3).

Run from polari-framework/:  python3 -m resources.measure_selftest
...
from resources.custom.profile_measure import (
