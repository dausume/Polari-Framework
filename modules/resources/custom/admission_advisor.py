"""
@cross-cutting
@module resources.custom.admission_advisor
@tags @xc:bindings
...
from resources.custom.node_resources import machine_resources_dict
from resources.custom.profile_analysis import declared_profile, find_profile
...
def assess_module_admission(manager, module_name, topology_name=''):
    ...
    if getattr(profile, 'character', '') == 'data':
        from resources.custom.profile_analysis import recommend_backend
