"""
@module resources.objects.profile.ModuleResourceProfile

Row class ModuleResourceProfile of the resources module — one class per file (design §7), split
from profile_basis.py (sap-2c). The class docstring below is the explanation.
"""
