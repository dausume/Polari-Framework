...
from materials_science.targetProfiles.targetMaterialProfile import TargetMaterialProfile
from materials_science.targetProfiles.propertyTarget import PropertyTarget
