...
from materials_science.custom.properties.propertyCategory import PropertyCategory

# Import categories
from materials_science.custom.properties.rheological import RheologicalProperty
from materials_science.custom.properties.mechanical import MechanicalProperty
from materials_science.custom.properties.surface import SurfaceProperty
from materials_science.custom.properties.thermal import ThermalProperty

# Import rheological properties
from materials_science.custom.properties.rheological.viscosity import (
    Viscosity, KrebsViscosity, StormerViscosity
)
from materials_science.custom.properties.rheological.elasticity import (
    Elasticity, StorageModulus, DMAMeasurement, RheometerMeasurement
)
from materials_science.custom.properties.rheological.meltFlowIndex import (
    MeltFlowIndex, MFIValue, MFIMeasurement
)

# Import mechanical properties
from materials_science.custom.properties.mechanical.hardness import (
    Hardness, HardnessScale, ShoreMeasurement
)
from materials_science.custom.properties.mechanical.tensileStrength import (
    TensileStrength, UltimateTensileStrength, TensileMeasurement
)

# Import surface properties
from materials_science.custom.properties.surface.solidSurfaceEnergy import (
    SolidSurfaceEnergy, CriticalSurfaceTension, ContactAngleMeasurement
)
from materials_science.custom.properties.surface.liquidSurfaceTension import (
    LiquidSurfaceTension, SurfaceTensionValue, WilhelmyMeasurement
)

# Import thermal properties
from materials_science.custom.properties.thermal.meltingPoint import (
    MeltingPoint, MeltingPointValue, DSCMeltingMeasurement
)
from materials_science.custom.properties.thermal.glassTransition import (
    GlassTransition, GlassTransitionTemp, DMAGlassTransitionMeasurement
)
from materials_science.custom.properties.thermal.smokingPoint import (
    SmokingPoint, SmokingPointValue, SmokingPointMeasurement
)
from materials_science.custom.properties.thermal.thermalExpansion import (
    ThermalExpansion, CoefficientOfThermalExpansion, TMAMeasurement
)

# Import physical properties
from materials_science.custom.properties.physical.specificGravity import (
