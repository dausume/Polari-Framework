...
from materials_science.custom.devices.deviceCategory import DeviceCategory

# 3D Printing Devices
from materials_science.custom.devices.threeDimensionalPrintingDevices import (
...
# CNC Mills
from materials_science.custom.devices.cncMills import (
    CNCMill,
    ThreeAxisMill,
    FiveAxisMill
)
...
# CNC Lathes
from materials_science.custom.devices.cncLathes import (
    CNCLathe
)

# Material Testing Devices
from materials_science.custom.devices.materialTestingDevices import (
