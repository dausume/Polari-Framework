...
def seed_initial_data(manager=None):
    ...
    """
    from materials_science.dataProvenance import DataProvenance, DataSource
    from materials_science.rawMaterials import RawMaterial
    from materials_science.materialAdditives import (
        MaterialAdditive, PropertyEffect, AdditiveCompatibility, Compatibilizer
    )
    from materials_science.targetProfiles import TargetMaterialProfile, PropertyTarget
    from materials_science.formulation import Formulation, FormulationComponent, FormulationIntent
