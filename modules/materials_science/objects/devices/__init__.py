...
from materials_science.objects.devices.deviceCategory import DeviceCategory

# 3D Printing Devices
from materials_science.objects.devices.threeDimensionalPrintingDevices import (
...
# CNC Mills
from materials_science.objects.devices.cncMills import (
    CNCMill,
    ThreeAxisMill,
    FiveAxisMill
)
...
# CNC Lathes
from materials_science.objects.devices.cncLathes import (
    CNCLathe
)

# Material Testing Devices
from materials_science.objects.devices.materialTestingDevices import (
