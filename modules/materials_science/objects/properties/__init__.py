...
from materials_science.objects.properties.propertyCategory import PropertyCategory

# Import categories
from materials_science.objects.properties.rheological import RheologicalProperty
from materials_science.objects.properties.mechanical import MechanicalProperty
from materials_science.objects.properties.surface import SurfaceProperty
from materials_science.objects.properties.thermal import ThermalProperty
...
from materials_science.objects.properties.mechanical.hardness import (
    Hardness, HardnessScale, ShoreMeasurement
)
from materials_science.objects.properties.mechanical.tensileStrength import (
    TensileStrength, UltimateTensileStrength, TensileMeasurement
)

# Import surface properties
from materials_science.objects.properties.surface.solidSurfaceEnergy import (
    SolidSurfaceEnergy, CriticalSurfaceTension, ContactAngleMeasurement
)
from materials_science.objects.properties.surface.liquidSurfaceTension import (
    LiquidSurfaceTension, SurfaceTensionValue, WilhelmyMeasurement
)

# Import thermal properties
from materials_science.objects.properties.thermal.meltingPoint import (
    MeltingPoint, MeltingPointValue, DSCMeltingMeasurement
)
from materials_science.objects.properties.thermal.glassTransition import (
    GlassTransition, GlassTransitionTemp, DMAGlassTransitionMeasurement
)
from materials_science.objects.properties.thermal.smokingPoint import (
    SmokingPoint, SmokingPointValue, SmokingPointMeasurement
)
from materials_science.objects.properties.thermal.thermalExpansion import (
    ThermalExpansion, CoefficientOfThermalExpansion, TMAMeasurement
)

# Import physical properties
from materials_science.objects.properties.physical.specificGravity import (
