"""
@cross-cutting
@module nutrition.custom.budget_analysis
@tags @xc:bindings
...
@consumers
  ...
  - nutrition.budget_selftest
@see AI-Notes/plans/MEAL_PLANNING_APP_PLAN.md §3b mpb-3
"""

from nutrition.custom.market_analysis import best_price_per_kg
from nutrition.custom.pantry_analysis import plan_cost
