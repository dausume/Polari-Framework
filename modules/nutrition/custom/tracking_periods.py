"""
@module nutrition.custom.tracking_periods
...
from nutrition.custom.tracking_analysis import tracking_series
...
def _lines(manager, person, sample_day=None):
    ...
    if sample_day:
        try:
            from nutrition.custom.tracking_analysis import intake_day
