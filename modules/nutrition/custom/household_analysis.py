"""
@cross-cutting
@module nutrition.custom.household_analysis
@tags @xc:bindings
...
@consumers
  - nutrition.custom.fulfillment_analysis, nutrition.household_api
@see /HOUSEHOLD_NUTRITION_PLAN.md §nut-4
"""

import json

from nutrition.custom.person_analysis import nutrient_needs, PERIOD_DAYS
