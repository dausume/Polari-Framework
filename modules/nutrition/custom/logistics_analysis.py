"""
@module nutrition.custom.logistics_analysis
...
MOVED the household-generic half to household.custom.household_analysis with
...
RE-EXPORTS the moved names so every `from nutrition.custom.logistics_analysis
...
from household.custom.household_analysis import (  # noqa: F401
...
def dish_plan(manager, plan, week_start=None, coordination=None):
    ...
    proposals, notes = [], []
    from nutrition.custom.workflow_analysis import derive_week_plan
