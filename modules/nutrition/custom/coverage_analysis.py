"""
@cross-cutting
@module nutrition.custom.coverage_analysis
@tags @xc:bindings
...
from nutrition.custom.exclusion_analysis import screen_foods
...
from nutrition.custom.tracking_analysis import _date_range, intake_day
