"""
@module nutrition.custom.cooknow_analysis
...
@consumers
  - nutrition.cooknow_api (GET /api/mealplanning/cooknow/{person},
    POST …/step-done)
  - AnalysisDefinition rows `nutrition.custom.cooknow_analysis:<fn>`
    (the cooknow seeds; the "Step done" form solution)
  - nutrition.cooknow_selftest
"""
...
from nutrition.custom.logistics_analysis import LOAD_UNITS_PER_TOOL, _dt, _iso
from nutrition.custom.workflow_analysis import METHOD_TO_TASK, resolve_method
