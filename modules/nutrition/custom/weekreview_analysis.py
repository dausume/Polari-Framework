"""
@cross-cutting
@module nutrition.custom.weekreview_analysis
@tags @xc:bindings
...
the analyses that already exist — nothing is re-derived here:
  ...
  week_review                 planned vs eaten (planning_analysis.
                              ...
                              fairness (household.custom.household_analysis.
...
from household.custom.household_analysis import fairness_readout
from nutrition.custom.budget_analysis import plan_budget_report
from nutrition.custom.person_analysis import _rows
from nutrition.custom.planning_analysis import _named, week_coverage
from nutrition.custom.purchase_analysis import (
...
PRIORS = [
    ...
    ('fairness', 'household.custom.household_analysis.fairness_readout windowed to the week: '
