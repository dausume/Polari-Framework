"""
@module nutrition.custom.purchase_analysis
...
from nutrition.custom.market_analysis import best_price_per_kg, resolve_grams
...
def coordinate_week(manager, plan=None, household='', week_start=None, today=None,
    ...
    try:
        from nutrition.custom import logistics_analysis as lg
    except ImportError:
        lg = None
