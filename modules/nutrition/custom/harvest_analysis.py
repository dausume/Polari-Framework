"""
@cross-cutting
@module nutrition.custom.harvest_analysis
@tags @xc:bindings
...
using aquaponics.custom.plant_growth_simplified's realized per-part volumes
...
aquaponics/custom/plant_growth_simplified.py (2026-07-15) for what that grow
...
@consumers
  - nutrition.custom.fulfillment_analysis (nut-5), nutrition.food_api
