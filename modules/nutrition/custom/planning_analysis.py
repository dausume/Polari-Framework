"""
@module nutrition.custom.planning_analysis
...
from nutrition.custom.meal_analysis import _json_list, template_rollup
...
def _slot_lines(manager, prof, person, frac):
    ...
    from nutrition.custom.tracking_periods import _lines
    daily = {}
...
def portion_fit(manager, template, variation='', slot='dinner', persons=None, household='',
    ...
    from nutrition.custom.person_analysis import nutrient_needs
