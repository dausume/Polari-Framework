"""
@module nutrition.thresholds_selftest
...
Run from polari-framework/:  python3 -m nutrition.thresholds_selftest
...
from nutrition.custom.person_analysis import tdee
