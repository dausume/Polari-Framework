"""
@module nutrition.today_selftest
...
Run from polari-framework/modules/:
  PYTHONPATH=..:../polariApiServer python3 -m nutrition.today_selftest
"""
...
from nutrition.custom.today_analysis import (
...
def main():
    ...
    check('analyses name callables that resolve',
          all(a['callable_ref'].startswith('nutrition.custom.today_analysis:') for a in SEED_TODAY_ANALYSES)
