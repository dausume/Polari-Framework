"""
@module nutrition.cooknow_selftest
...
Run from polari-framework/modules/:
  PYTHONPATH=..:../polariApiServer python3 -m nutrition.cooknow_selftest
"""
...
from nutrition.custom.cooknow_analysis import cook_sheet, step_done_proposal
...
def main():
    ...
    check('the analyses resolve to our module and the solution\'s AnalysisCall names a seeded analysis',
          all(a['callable_ref'].startswith('nutrition.custom.cooknow_analysis:') for a in cs.SEED_COOKNOW_ANALYSES)
