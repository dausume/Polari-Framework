"""
@module nutrition.meal_selftest
...
Run from polari-framework/:  python3 -m nutrition.meal_selftest
...
from nutrition.meal_basis import (SEED_MEAL_TEMPLATES,
                                  SEED_VARIATIONS)
from nutrition.custom.meal_analysis import (plan_rollup, template_rollup,
                                     validate_template)
