"""
@module nutrition.planning_selftest
...
Run from polari-framework/modules/:
  PYTHONPATH=..:../polariApiServer python3 -m nutrition.planning_selftest
"""
...
from nutrition.custom.planning_analysis import (
...
def main():
    ...
    from nutrition.custom.planning_analysis import DEFAULT_FIT_WEIGHTS
