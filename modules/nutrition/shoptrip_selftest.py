"""
@module nutrition.shoptrip_selftest
...
Run from polari-framework/modules/:
  PYTHONPATH=..:../polariApiServer python3 -m nutrition.shoptrip_selftest
"""
...
def main():
    ...
    check('analyses name this module\'s callables; triggers list is empty by design',
          all(a['callable_ref'].startswith('nutrition.custom.shoptrip_analysis:') for a in SEED_SHOPTRIP_ANALYSES)
