"""
@module nutrition.weekreview_selftest
...
Run from polari-framework/modules/:
  PYTHONPATH=..:../polariApiServer python3 -m nutrition.weekreview_selftest
"""
...
def main():
    ...
    check('AnalysisDefinitions name the three functions with resolvable callable_refs',
          {a['callable_ref'] for a in ws.SEED_WEEKREVIEW_ANALYSES} == {
              'nutrition.custom.weekreview_analysis:week_review',
              'nutrition.custom.weekreview_analysis:next_week_proposals',
              'nutrition.custom.weekreview_analysis:weekly_review_event_proposal'})
