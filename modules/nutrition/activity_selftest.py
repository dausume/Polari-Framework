"""
@module nutrition.activity_selftest
...
Run from polari-framework/:  python3 -m nutrition.activity_selftest
"""
...
from nutrition.activity_basis import (SEED_ACTIVITY_DEFINITIONS,
                                      intensity_band)
from nutrition.custom.activity_analysis import (activity_kcal, day_timeline,
