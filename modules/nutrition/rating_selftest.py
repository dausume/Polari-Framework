"""
@module nutrition.rating_selftest
...
Run from polari-framework/modules/:
  PYTHONPATH=..:../polariApiServer python3 -m nutrition.rating_selftest
"""

from types import SimpleNamespace

from nutrition.rating_basis import SEED_MEAL_RATINGS
from nutrition.custom.rating_analysis import rank_templates, rating_summary
