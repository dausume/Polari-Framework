"""
@module nutrition.affinity_selftest
...
Run from polari-framework/:  python3 -m nutrition.affinity_selftest
"""
...
from nutrition.custom.affinity_composer import (affinity_for, compose,
                                         counterbalance)
