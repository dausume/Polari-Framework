"""
@module nutrition.objects.person.PersonProfile

Row class PersonProfile of the nutrition module — one class per file (design §7), split
from person_basis.py (sap-2c). The class docstring below is the explanation.
"""
