"""
@module nutrition.data_selftest
...
Run from polari-framework/:  python3 -m nutrition.data_selftest
Stdlib-only; no manager, no DB, no server.
"""

from nutrition.custom.dga_limits import AMDR, DGA_EDITION, DGA_LIMITS
...
from nutrition.custom import vendor_data
...
def main():
    ...
    from nutrition.custom.dga_limits import total_sugars_ceiling_g
