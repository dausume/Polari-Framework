"""
@module supplychain.magnetic_sourcing_selftest
...
Run from polari-framework/:
    python3 -m supplychain.magnetic_sourcing_selftest
"""
...
from supplychain.custom.sourcing_analysis import normalized_price
