"""
@cross-cutting
@module collab.realtime_schemas
@tags @xc:bindings
...
@consumers
  ...
  - collab.selftest_collab (catalog/codec invariants + file lockstep)
...
@see modules/collab/polari-realtime.schema.json (generated artifact;
     regenerate with `python3 -m collab.realtime_schemas --write`)
"""
...
#: clients). Regenerate with `python3 -m collab.realtime_schemas
