"""
Selftest for cntfet.cnt_blocks_page — the FUNCTIONAL-BLOCK rung (counter,
ALU, FSM, register) composed from the standard cells.

Run from polari-framework/modules/:
  PYTHONPATH=..:../polariApiServer python3 -m cntfet.blocks_selftest
...
from cntfet import cnt_blocks_page as b
...
from cntfet.evidence_selftest import _mgr as _evidence_mgr
...
def main():
    ...
    try:
        from sifet.custom.si_device import derive_si_device, get_row as si_get
