"""
Selftest for cntfet.custom.cnt_parts_svg (fg-3: the 2-D parts view as
data — regions from the same rows the parts list names).

Run from polari-framework/modules/:
  PYTHONPATH=..:../polariApiServer python3 -m cntfet.parts2d_selftest
"""
...
from cntfet.custom.cnt_parts_svg import (
