"""@module cntfet.objects.cnt_ip._shared — what the cnt_ip row classes share (constants, seeds, helpers); split from cnt_ip_basis.py (sap-2c)."""
import json
...
SEED_TECHNOLOGY_IP = [
    ...
    _rec('vs-compact-model', 'VS-CNFET-derived compact model (ours)',
         ...
         sources=['cntfet/custom/cnt_vs_model.py docstring',
