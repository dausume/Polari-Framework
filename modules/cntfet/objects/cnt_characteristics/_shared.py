"""@module cntfet.objects.cnt_characteristics._shared — what the cnt_characteristics row classes share (constants, seeds, helpers); split from cnt_characteristics_basis.py (sap-2c)."""
import json
