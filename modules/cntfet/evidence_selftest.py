"""
Selftest for cntfet.cnt_evidence_basis (evidence + proof-of-freedom).

    cd modules && PYTHONPATH=..:../polariApiServer \\
        python3 -m cntfet.evidence_selftest
"""
...
from cntfet.cnt_characteristics_basis import SEED_FET_CHARACTERISTICS
from cntfet.cnt_regimes_basis import SEED_FET_REGIMES
from cntfet.cnt_transport_basis import SEED_SCATTERING_MECHANISMS
