...
Run from polari-framework/modules/:
  PYTHONPATH=..:../polariApiServer python3 -m cntfet.selftest_fields
"""
...
from cntfet import cnt_fields as cf
from cntfet import cnt_scene as cs
from cntfet import selftest_cntfet as st
from cntfet.selftest_cntfet import check
