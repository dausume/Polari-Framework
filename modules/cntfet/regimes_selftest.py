"""
Selftest for cntfet.cnt_regimes_basis (fv-1: regimes as data + the IV
regime map / exponent / regime-coloured output rows).

Run from polari-framework/modules/:
  PYTHONPATH=..:../polariApiServer python3 -m cntfet.regimes_selftest
"""
...
from cntfet import cnt_regimes_basis as rg
