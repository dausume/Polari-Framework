"""
@module cntfet.custom.cnt_derive
...
from cntfet.custom.cnt_tob import tob_iv
from cntfet.custom.cnt_vs_model import build_vs_params, iv_family
...
def run_iv(manager, device, engine='vs', vg_list=None, vd_list=None,
    ...
    if engine == 'vs':
        params = build_vs_params(
            ...
            device.temperature_k)
        if profile == 'VS_FULL':
            from cntfet.custom.cnt_constants import lit_value
            from cntfet.custom.cnt_extrinsics import vs_full_current
