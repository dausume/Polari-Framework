"""
@module cntfet.custom.cnt_constants
...
@consumers
  - cntfet.custom.cnt_bandstructure / cnt_tob / cnt_vs_model (equations)
  - cntfet.cnt_calibration_seed (anchor rows)
  - cntfet.cntfet_selftest (value pins)
"""
