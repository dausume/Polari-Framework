"""
@module cntfet.custom.cnt_cell_advance
...
@consumers
  ...
  - cntfet.cell_advance_selftest
"""

from cntfet.custom.cnt_cells import PARASITIC_STANDIN_F
...
def _coarse_grid(manager, device, vdd):
    ...
    from cntfet.cnt_cell_library_basis import _pair_params, _tau_estimate
