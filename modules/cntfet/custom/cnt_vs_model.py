"""
@module cntfet.custom.cnt_vs_model
...
@consumers
  - cntfet.custom.cnt_derive (parameter stamping)
  - cntfet.custom.cnt_osdi (equivalence regression reference leg)
...
def _charge_extras(eg, cox):
    from cntfet.custom.cnt_charge import charge_extras_for
