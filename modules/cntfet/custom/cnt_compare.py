"""
@module cntfet.custom.cnt_compare
...
@consumers
  ...
  - cntfet.cnt_device_viz_seed (curve 'compare')
...
from cntfet.cnt_page import _device_graph, _row, _sapi
from cntfet.cnt_scoring_seed import CONCEPT_NAME, FET_TERMS, score_device
...
def _generic_detail_page():
    ...
    from cntfet.cnt_scene_seed import scene_page_items
    d = '{object}'
    rows = [
