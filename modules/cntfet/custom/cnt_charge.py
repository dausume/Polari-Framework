"""
@module cntfet.custom.cnt_charge
...
@consumers
  - cntfet.cnt_verilog_a_endpoints (the r3 ddt contributions mirror these)
  - cntfet.custom.cnt_ring_oscillator (delay context)
  - cntfet.cntfet_selftest (Cgg qualitative pins + AC cross-check)
"""

import math

from cntfet.custom.cnt_constants import Q_C, lit_value
from cntfet.custom.cnt_vs_model import _logistic, _softplus
