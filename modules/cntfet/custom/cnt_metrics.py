"""
@module cntfet.custom.cnt_metrics
...
@consumers
  - cntfet.custom.cnt_triangle (F1-vs-F2 edges)
  - cntfet.cnt_calibration_seed (anchor comparisons)
  - cntfet.cntfet_selftest
"""

import math

from cntfet.custom.cnt_constants import H_JS, Q_C
