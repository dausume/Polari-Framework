"""
Selftest for cntfet.cnt_block_page (rank 3 of the ladder): general
...
Run from polari-framework/modules/:
  PYTHONPATH=..:../polariApiServer python3 -m cntfet.block_pages_selftest
"""
