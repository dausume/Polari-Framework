"""
Selftest for cntfet.cnt_level_scenes — the MULTISCALE scenes: FETs
...
Run from polari-framework/modules/:
  PYTHONPATH=..:../polariApiServer python3 -m cntfet.selftest_level_scenes
"""
...
from cntfet.cnt_level_scenes import (
