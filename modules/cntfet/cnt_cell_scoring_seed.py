"""
@module cntfet.cnt_cell_scoring_seed
...
@consumers
  ...
  - cntfet.cnt_device_viz_seed (curve 'cell-scores')
...
def _term(name, display, key, lo, hi, tags=()):
    ...
    return {
        ...
        'source': 'cntfet.cnt_cell_scoring_seed (fi-2 cells)',
...
SEED_CELL_SCORE_CONCEPTS = [{
    ...
    'description': 'Weighted mean of the standard-cell figures of '
                   ...
                   'intrinsic limit (cntfet.cnt_cell_scoring_seed '
...
def cell_frames(parsed, tau_s, vdd):
    ...
    from cntfet.cnt_cell_library_basis import fet_count
