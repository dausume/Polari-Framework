"""
Selftest for cntfet.cnt_open_library_page (the OPEN LIBRARY gate).

    cd modules && PYTHONPATH=..:../polariApiServer \\
        python3 -m cntfet.open_library_selftest
...
from cntfet import cnt_open_library_page as ol
...
from cntfet.cnt_evidence_basis import DISCLAIMER, SEED_EVIDENCE
from cntfet.cnt_ip_basis import SEED_TECHNOLOGY_IP
...
def main():
    ...
    if ngspice_path is None:
        ...
        from cntfet.cnt_cell_library_basis import _pair_params
