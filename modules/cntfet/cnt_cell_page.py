...
from cntfet.cnt_cell_library_basis import CELL_LIBRARY, fet_count
from cntfet.custom.cnt_compare import _component_item
from cntfet.custom.cnt_derive import get_row
from cntfet.cnt_page import _row, _sapi
...
def _kind(cell):
    from cntfet.custom.cnt_cell_coverage import _sequential_keys, _tristate_keys
...
def cell_config_summary(manager, cell, device_name):
    ...
    from cntfet.cnt_power_basis import cell_power
...
def used_in_blocks(cell, device_name=''):
    ...
    try:
        from cntfet.cnt_blocks_page import BLOCK_LIBRARY, block_cells
    except ImportError:
        return []
    out = []
