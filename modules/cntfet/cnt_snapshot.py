...
SNAPSHOT_CLASSES = [
    ...
    ('CellCharacterizationRun', 'cntfet', 'cntfet.cnt_characterization'),
    ('OpenCellLibrary', 'cntfet', 'cntfet.cnt_open_library'),
    ('FunctionalBlock', 'cntfet', 'cntfet.cnt_blocks'),
]
...
EXCLUDED = {
    ...
    'SiliconProcessNode / CNTCalibrationAnchor': 'seeds in sifet.si_ladder + cnt_basis',
