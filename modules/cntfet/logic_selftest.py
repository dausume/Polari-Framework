"""
Selftest for cntfet.custom.cnt_logic (fp-5: boolean AST, gate DAG, truth
tables, schematic graph, switch-level proof, state space).

Run from polari-framework/modules/:
  PYTHONPATH=..:../polariApiServer python3 -m cntfet.logic_selftest
...
from cntfet.cnt_cell_library_basis import CELL_LIBRARY, COMBINATIONAL
