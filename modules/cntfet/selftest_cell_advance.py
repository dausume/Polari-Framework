"""
Selftest for cntfet.cnt_cell_advance (the first-step service):
...
Run from polari-framework/modules/:
  PYTHONPATH=..:../polariApiServer python3 -m cntfet.selftest_cell_advance
"""
...
from cntfet.cnt_cell_advance import (
