...
Run from polari-framework/:
  PYTHONPATH=. python3 -m cntfet.cntfet_selftest
...
from cntfet.custom import cnt_bandstructure as bs
from cntfet import cnt_calibration_seed as cal
from cntfet.custom import cnt_capability as cap
from cntfet.custom import cnt_derive as cd
from cntfet.custom import cnt_osdi as osdi
from cntfet.custom import cnt_tob as tob
from cntfet.custom import cnt_validate as cv
from cntfet import cnt_verilog_a_endpoints as va
from cntfet.custom import cnt_vs_model as vs
...
def main():
    ...
    from cntfet.cnt_reference_papers_seed import (
    ...
    from cntfet.custom.cnt_metrics import G0_FC10_S, extract_metrics
    ...
    from cntfet.cnt_figures_seed import (
    ...
    from cntfet.cnt_figures_seed import SEED_CNTFET_FIGURE_GRAPHS
    ...
    from cntfet.custom.cnt_compare import (
    ...
    from cntfet.cnt_characteristics_basis import (
        SEED_FET_CHARACTERISTICS, characteristic_detail,
        characteristics_index,
    )
    from cntfet.cnt_device_viz_seed import extra_curve_builders, extra_graph_seeds
    ...
    from cntfet.custom.cnt_compare import detail_pages
    ...
    from cntfet.cnt_taxonomy_basis import device_taxonomy_report, score_signal
    from cntfet.custom.cnt_logic import cell_logic_report, library_logic_report
    from sifet.si_basis import SEED_TABLES as SI_SEED_TABLES
    from sifet.custom.si_device import derive_si_device
    ...
    from cntfet.cnt_ip_basis import (
    ...
    from cntfet.cnt_evidence_basis import (
    ...
    from cntfet.custom.cnt_cell_coverage import cells_coverage, device_cell_coverage
    ...
    from cntfet.cnt_blocks_page import (
        BLOCK_LIBRARY, block_provenance, generate, prove_block,
    )
    from cntfet.cnt_open_library_page import admit_cells
    from cntfet.cnt_cell_library_basis import CELL_LIBRARY as _CL
    ...
    from cntfet.cnt_cell_library_basis import _liberty_library
    tau_fake = 0.1e-12
    def _pt(scale):
    ...
    from cntfet.custom.cnt_fo4 import fo4_report, fo4_rows
    ...
    from cntfet.custom.cnt_charge import cgg_f, cqinf_f_per_m
    ...
    if openvaf_path and ngspice_path:
        ...
        from cntfet.custom.cnt_ring_oscillator import run_ring_oscillator
    ...
    # ---- [VS2] extrinsics -----------------------------------------
    from cntfet.custom.cnt_extrinsics import (
    ...
    if openvaf_path and ngspice_path:
        ...
        from cntfet.custom.cnt_sequential import (
    ...
    from cntfet.custom.cnt_kwant import f3_oracle, find_kwant_python, \
    ...
    if kwant_python:
        ...
        from cntfet.custom.cnt_kwant import poisson_pin
