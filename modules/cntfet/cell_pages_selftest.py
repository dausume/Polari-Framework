"""
Selftest for cntfet.cnt_cell_page (the cell arc, 2026-08-31):
...
Run from polari-framework/modules/:
  PYTHONPATH=..:../polariApiServer python3 -m cntfet.cell_pages_selftest
"""
...
from cntfet.cnt_cell_page import (
...
def main():
    ...
    check('cell-summary/1 (general): identity from CELL_LIBRARY '
          ...
          == len({d for d, _c in
                  __import__('cntfet.cnt_cell_page',
