"""
@module cntfet.cnt_level_scenes
...
from cntfet.cnt_fields import FIELD_KNOBS
...
def _fet_footprint(manager, device_name, tech):
    ...
    if tech == 'cnt':
        from cntfet.cnt_scene import _geometry
        k = dict(FIELD_KNOBS)
    ...
    from sifet.si_scene import _si_pieces
...
def cell_scene(manager, cell, device_name, dim='3d', lod='real',
    ...
    if use_real:
        if lay['tech'] == 'cnt':
            from cntfet.cnt_scene import _geometry, _pieces
