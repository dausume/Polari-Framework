...
@consumers climate.co2_settings, climate.climate_views,
climate.climate_api, climate.selftest_climate
"""
...
def _co2_mg_per_m3_per_ppm():
    from aquaponics.atmosphere_analysis import CO2_MG_PER_M3_PER_PPM
...
def direct_burn_offset_ppm(kg_per_hour, volume_m3,
    ...
    from climate.co2_indoor import steady_state_ppm
