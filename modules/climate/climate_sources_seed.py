"""
@module climate.climate_sources_seed
...
@consumers climate.custom.series_ingest, climate.climate_api, polariServer
"""
...
SEED_CLIMATE_ENDPOINTS = [
    ...
    _ep('gcb-global-carbon-budget',
        ...
        notes='480363 bytes observed 2026-08-02. THE PUBLISHED '
              ...
              'sheet is read by climate.custom.xlsx_reader - openpyxl is '
