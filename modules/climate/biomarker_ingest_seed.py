"""
@cross-cutting
@module climate.biomarker_ingest_seed
@tags @xc:bindings
...
def ingest_bicarbonate_cycle(manager, cycle, fetcher=None):
    ...
    from climate.custom.series_ingest import record_retrieval_row
    from climate.custom.xpt_reader import column_summary, read_xpt_bytes
