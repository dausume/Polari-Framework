"""
@module climate.custom.co2_scenarios
...
def build_scenarios(manager, background_ppm,
    ...
    # ---- HISTORICAL -----------------------------------------
    from climate.custom.co2_combustion import hearth_dwelling_estimate
    ...
    # ---- FUTURE ---------------------------------------------
    from climate.custom.co2_crossing import build_fits
    from climate.custom.co2_trend import project
...
def modern_worst_case(manager, background_ppm,
    ...
    """
    from climate.co2_settings_seed import local_outdoor_ppm
...
def urban_bedroom_trajectory(manager, from_year=None,
    ...
    """
    from climate.co2_settings_seed import local_outdoor_ppm
    from climate.custom.co2_trend import crossing_year, fit_trend, project
    from climate.custom.series_ingest import series_points
