...
from climate.series_parsers import get_parser, series_bounds
...
def record_retrieval_row(manager, series, endpoint, parsed,
    ...
    seed = {
        ...
        'retrieved_at': _now(),
        'retrieved_by': retrieved_by or 'climate.series_ingest',
    ...
    try:
        from dmvdata.gov_sources import SourceRetrieval
