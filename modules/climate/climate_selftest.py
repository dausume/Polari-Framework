"""
@module climate.climate_selftest
...
Run from polari-framework/: python3 -m climate.climate_selftest
"""
...
from climate.custom.biomarker_link import (
...
from climate.custom.climate_export import (
...
from climate.co2_indoor_seed import (
...
from climate.custom.co2_trend import (
    compare_velocity, crossing_band, crossing_year, fit_trend,
)
from climate.custom.series_parsers import (
...
from climate.custom.xpt_reader import make_min_xport, read_xpt_bytes
...
from climate.climate_sources_seed import SEED_CLIMATE_GOV_SOURCES
...
from dmvdata.gov_sources_basis import SOURCE_TABLES
from dmvdata.legal_sources_basis import AcademicSource, JournalisticSource
...
from dmvdata.gov_sources_basis import SEED_GOV_SOURCES as _DMV_GOV
...
from climate.custom.co2_combustion import (
...
from climate.co2_indoor_seed import person_co2_mg_per_day
...
from climate.custom.climate_claims import (
...
from climate.climate_page import BUDGET_GRAPHS, graph_data
...
from climate.custom.co2_biochemistry import (
    assay_change_flag, biochemistry_report, stability_across_cycles,
    within_person_association,
)
from climate.custom.co2_disorders import window_sensitivity
from climate.climate_page import SEED_CLIMATE_ERA_DISPLAYS
...
from climate.custom.co2_scenarios import (
...
from climate.climate_page import TRAJECTORY_GRAPHS
...
from climate.custom.co2_scenarios import threshold_attribution
