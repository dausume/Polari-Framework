"""@module appstore.objects.appstore_forks._shared — what the appstore_forks row classes share (constants, seeds, helpers); split from appstore_forks_basis.py (sap-2c)."""
