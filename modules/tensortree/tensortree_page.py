...
SEED_TENSORTREE_PAGE_DISPLAYS = [
    _page('tensortree', 'tensortree',
          ...
          'TensorTreeDefinition', [
              ...
              _row(1, [{'id': 'tensortree-wind-scene', 'index': 0, 'type': 'component', 'rowSegmentsUsed': 12, 'gridColumnStart': None,
              ...
              _row(2, [_table('tensortree-nodes', 0, 6, 'Nodes — status is set by the validator', 'TensorNode', columns='tree,name,parent,title,tensor,dims_json,binding_ref,status'),
              ...
              _row(3, [_table('tensortree-dims', 0, 12, 'Localized dimensions and their visual channel', 'LocalizedDimension', columns='node,name,dimension,range_json,channel,scale_json,coherent')]),
              _row(4, [_table('tensortree-mappings', 0, 12, 'Mappings — kind, the dims at both ends, validity, loss, two statuses, evidence', 'TensorMapping',
              ...
              _row(5, [_table('tensortree-selections', 0, 6, 'Selections — a click that is a mathematical object', 'TensorSelection', columns='name,node,ranges_json,created_from,created_at'),
