...
SEED_PROOF_TECH_NODES = [
    ...
    _n('pf-two-sources-agree', 'Two independent sources agreeing is evidence', 'LEF footprints summed and the Liberty\'s areas; our transistor-level delays and the foundry\'s over 21 arcs of 8 cells; extraction narrowing every fall gap and widening the rise gap only where the schematic was already slow — witnesses on the rows, never theorems; a two-cell statement REFUTED on 21 arcs is knowledge too; two libraries\' twin cells put under ONE set of conditions before any number is compared.',
       depends=('pf-witness-vs-proof',), claims=('lod3-lef-area-equals-liberty-area', 'lod3b-falls-faster-than-liberty', 'lod3c-extraction-slows-every-arc', 'lod3c-extraction-narrows-every-fall-gap', 'lod3c-extraction-widens-every-rise-gap', 'lod3c-extraction-widens-the-rise-gap-where-already-slow', 'lod2c-cnt-twin-faster-at-own-fo4', 'lod2c-sky130-twin-slower-at-the-cnt-point'),
