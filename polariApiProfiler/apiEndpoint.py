...
COMMON_ENDPOINTS = [
    ...
    # GeoJSON - USGS Earthquakes (last hour)
    {
        'name': 'usgs-earthquakes-hour',
        'displayName': 'USGS Earthquakes (Last Hour)',
        'description': 'Real-time earthquake data from USGS in GeoJSON FeatureCollection format',
        'domainName': '',
        'endpointPath': '',
        'url': 'https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_hour.geojson',
        'httpMethod': 'GET',
        'defaultHeaders': {},
        'responseRootPath': 'features',
        'linkedProfileName': 'geoJson',
        'persistData': False,
        'polariClassName': '',
        'isActive': True,
        'authType': 'none',
        'tags': ['geojson', 'usgs', 'earthquakes', 'real-time']
    },
    # GeoJSON - USGS Earthquakes (last day - more data)
    {
        'name': 'usgs-earthquakes-day',
        'displayName': 'USGS Earthquakes (Last 24h)',
        'description': 'Earthquake data from past 24 hours - larger dataset for testing',
        'domainName': '',
        'endpointPath': '',
    ...
    # Single Object - JSONPlaceholder single user
    {
        'name': 'mock-single-user',
        'displayName': 'Mock Single User (JSONPlaceholder)',
        'description': 'Single user object - tests singleObject profile',
        'domainName': '',
        'endpointPath': '',
        ...
        'defaultHeaders': {},
        'responseRootPath': '',
        'linkedProfileName': 'singleObject',
        'persistData': False,
        'polariClassName': '',
        'isActive': True,
        'authType': 'none',
        'tags': ['mock', 'test', 'single-object']
    },
    # Paginated - PokeAPI (small limit)
    {
        'name': 'pokeapi-pokemon',
        'displayName': 'PokeAPI Pokemon (Paginated)',
        'description': 'Paginated Pokemon list - tests paginated profile with count/next/previous/results',
        'domainName': '',
        'endpointPath': '',
        'url': 'https://pokeapi.co/api/v2/pokemon?limit=5',
        'httpMethod': 'GET',
        'defaultHeaders': {},
        'responseRootPath': 'results',
        'linkedProfileName': 'paginated',
        'persistData': False,
        'polariClassName': '',
        'isActive': True,
        'authType': 'none',
        'tags': ['paginated', 'pokeapi', 'test']
    },
    # Wrapped Response - Dog CEO API (message/status wrapper)
    {
        'name': 'dog-breeds',
        'displayName': 'Dog CEO Random Image',
        'description': 'Random dog image - tests wrapped response with message/status',
        'domainName': '',
        'endpointPath': '',
        'url': 'https://dog.ceo/api/breeds/image/random',
        'httpMethod': 'GET',
        'defaultHeaders': {},
        'responseRootPath': 'message',
        'linkedProfileName': 'wrappedResponse',
        'persistData': False,
        'polariClassName': '',
        'isActive': True,
        'authType': 'none',
        'tags': ['wrapped', 'test', 'images']
    },
    # Rick and Morty API - has info+results structure (paginated variant)
    {
        'name': 'rickmorty-characters',
        'displayName': 'Rick & Morty Characters',
        'description': 'Paginated character list with info metadata',
        'domainName': '',
        'endpointPath': '',
        ...
        'isActive': True,
        'authType': 'none',
        'tags': ['paginated', 'test', 'characters']
    },
]
