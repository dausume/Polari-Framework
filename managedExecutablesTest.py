...
class managedExecutable_testClass(unittest.TestCase):
    ...
    def test_singleDefault(self):
        classJSON = getJSONforClass(definingFile='managedExecutables', className='managedExecutable', passedInstances=self.defaultTestClass )
        logging.info(classJSON)

    def test_singleNamed(self):
        classJSON = getJSONforClass(definingFile='managedExecutables', className='managedExecutable', passedInstances=self.namedTestClass)
        logging.info(classJSON)
