"""
@cross-cutting
@module resources.profile_measure
@tags @xc:bindings
...
from resources.profile_analysis import find_profile
...
def _fetch_process_block(url, fetch=None):
    ...
    from resources.node_resources import _default_fetch
